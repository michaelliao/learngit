...
二、Git IDE 插件
Eclipse、Myeclipse 插件下载Netbeans 插件下载IntelliJ IDEA 插件下载Visual Studio 插件下载Atom 插件下载Sublime Text 插件下载
三、Git 浏览器插件
Git 浏览器插件下载（Chrome、Firefox、Safari、Opera，支持码云和Github）Octotree 浏览器插件下载（Chrome，支持Github）GitLab-TreeView 浏览器插件下载（Chrome，支持GitLab）
四、在线 Git 代码托管平台
码云 Gitee 官网GitHub 官网GitLab 官网Bitbucket 官网
五、搭建 Git 服务
GitLab 开源版本下载Gitblit 开源版本下载Gogs 开源版本下载Gitea 开源版本下载Gitosis 开源版本下载Gitolite 开源版本下载GitStack 开源版本下载Gidder开源版本下载
六、Git 教程
